...
const relatedSearches = [
  ...
  { label: "Branded links", href: "/blogs/branded-links-guide" },
  { label: "How URL shorteners work", href: "/blogs/how-url-shortners-work" },
  { label: "URL shortening best practices", href: "/blogs/url-shortening-best-practices" },
