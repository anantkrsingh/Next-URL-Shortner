  ...
  return (
    <div className="min-h-[28rem] w-full flex items-center justify-center bg-gray-50 py-12">
      <div className="flex p-10 rounded-[2rem] bg-white border border-gray-200 shadow-[0_1px_1px_rgba(0,0,0,0.05),0_4px_6px_rgba(34,42,53,0.04),0_24px_68px_rgba(47,48,55,0.05),0_2px_3px_rgba(0,0,0,0.04)] flex-col gap-6 w-[90%] mx-auto">
        ...
        <div className="flex flex-row flex-wrap justify-between items-center gap-2 text-gray-700">
          <Link href="/" className="hover:text-blue-600 transition-colors">ShortURL</Link>
          <div className="w-[1px] h-4 bg-gray-300"></div>
          <Link href="/click-counter" className="hover:text-blue-600 transition-colors">URL Click Counter</Link>
          <div className="w-[1px] h-4 bg-gray-300"></div>
          <Link href="/unshorten" className="hover:text-blue-600 transition-colors">Unshorten URL</Link>
          <div className="w-[1px] h-4 bg-gray-300"></div>
